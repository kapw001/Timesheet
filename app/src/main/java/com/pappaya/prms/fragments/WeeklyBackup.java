 ...
 */
public class WeeklyBackup extends Fragment implements AddDeleteRow {
        ...
        startDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                for (int i = 0; i < addDatesList.size(); i++) {
                    Log.e(TAG, "onClick: " + addDatesList.get(i).is_timesheet() + "   " + addDatesList.get(i).getProject());
                }
            }
        });
...
//                            for (int j = 0; j < mytimesheetapprove.length(); j++) {
                        ...
                        Toast.makeText(getActivity(), "" + addDatesList.size() + "      " + addDatesListSubmit.size(), Toast.LENGTH_SHORT).show();

//
//                        for (int i = 0; i < addDatesList.size(); i++) {
//                            AddDates addDates = addDatesList.get(i);
//                            Log.e(TAG, "onSuccess: Final Values :   " + addDates.getStatus() + "   " + addDates.getDate());
//                        }
